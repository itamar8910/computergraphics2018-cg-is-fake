...
void main(){
  ...
  // Vector that goes from the vertex to the light, in camera space. M is ommited because it's identity.
	...
	LightDirection_cameraspace = LightPosition_cameraspace + EyeDirection_cameraspace; // TODO we could just do LightPosition_cameraspace - vertexPosition_cameraspace ?
