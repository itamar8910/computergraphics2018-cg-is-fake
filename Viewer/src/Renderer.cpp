...
float getXOfLine(const glm::vec3& point1, const glm::vec3& point2, float y){
...
float get_x_intersection(const glm::vec2& p1, const glm::vec2& p2, float y){
	float a = (p2.y - p1.y) / (p2.x - p1.x);
	float b = p1.y;
	return ((y - b)/a) + p1.x;
}
pair<glm::vec2, glm::vec2> sortByX(const glm::vec2& p1, const glm::vec2& p2){
